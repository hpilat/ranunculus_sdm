...
```{r}
basin.na <- st_read("data/hybas_na_lev01-12_v1c/hybas_na_lev02_v1c.shp")
basin.ar <- st_read("data/hybas_ar_lev01-12_v1c/hybas_ar_lev02_v1c.shp")
```
...
```{r}
# dir.create("data/continental_divide")
write_sf(western.divide, "data/continental_divide/continental_divide.shp")
```
...
```{r}
write_sf(western.final.boundary, "data/continental_divide_buffer_boundary.tif")
```