...
NOTE from Hannah: I was unable to save the files using relative paths. I had to 
input my working directory in order for this .Rmd to run. I don't know how to 
adjust the working directory properly for this file without messing up everything else.
...
```{r}
basin.na <- st_read("C:/Users/PilatH/OneDrive - AGR-AGR/Desktop/ranunculus_sdm/data/raw/hybas_na_lev01-12_v1c/hybas_na_lev02_v1c.shp")
basin.ar <- st_read("C:/Users/PilatH/OneDrive - AGR-AGR/Desktop/ranunculus_sdm/data/raw/hybas_ar_lev01-12_v1c/hybas_ar_lev02_v1c.shp")
```
...
```{r}
write_sf(western.divide, "C:/Users/PilatH/OneDrive - AGR-AGR/Desktop/ranunculus_sdm/data/extents/continental_divide.shp")
```
...
Now we can buffer the border of the divide 200km eastward!
...
```{r}
write_sf(western.final.boundary, "C:/Users/PilatH/OneDrive - AGR-AGR/Desktop/ranunculus_sdm/data/extents/continental_divide_buffer_boundary.shp")
```